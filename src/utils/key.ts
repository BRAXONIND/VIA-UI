...
function generateMacros(
  ...
  for (let idx = 0; idx < numMacros; idx++) {
    const newName = macroNames[idx] || `M${idx}`;
    const newCode = `MACRO(${idx})`;
    const newTitle = `${newName} (M${idx})`;
    res = [
      ...res,
      {name: newName, shortName: `M${idx}`, title: newTitle, code: newCode},
    ];
  }
  return res;
}
...
export function getKeycodes(
  ...
  return [
    ...
    },
    {
      ...
      width: 'label',
      keycodes: [
        {name: 'Mission Control', shortName: 'Mission', code: 'KC_MCTL'},
        {name: 'Launchpad', shortName: 'Launch', code: 'KC_LPAD'},
        {name: 'Brightness -', shortName: 'Bright -', code: 'KC_BRID'},
        {name: 'Brightness +', shortName: 'Bright +', code: 'KC_BRIU'},
        {name: 'Spotlight', code: 'G(KC_SPC)', title: 'Command + Space'},
        {name: 'App Switch', code: 'G(KC_TAB)', title: 'Command + Tab'},
        {name: 'Next Window', code: 'G(KC_GRV)', title: 'Command + `'},
        {name: 'Quit App', code: 'G(KC_Q)', title: 'Command + Q'},
        {name: 'Close Window', shortName: 'Close', code: 'G(KC_W)'},
        {name: 'Minimize', code: 'G(KC_M)', title: 'Command + M'},
        {name: 'Hide App', code: 'G(KC_H)', title: 'Command + H'},
        {
          name: 'Force Quit',
          code: 'G(A(KC_ESC))',
          title: 'Command + Option + Escape',
        },
        {
          name: 'Lock Screen',
          code: 'C(G(KC_Q))',
          title: 'Control + Command + Q',
        },
        {name: 'New', code: 'G(KC_N)', title: 'Command + N'},
        {name: 'Open', code: 'G(KC_O)', title: 'Command + O'},
        {name: 'Save', code: 'G(KC_S)', title: 'Command + S'},
        {name: 'Print', code: 'G(KC_P)', title: 'Command + P'},
        {name: 'Cut', code: 'G(KC_X)', title: 'Command + X'},
        {name: 'Copy', code: 'G(KC_C)', title: 'Command + C'},
        {name: 'Paste', code: 'G(KC_V)', title: 'Command + V'},
        {name: 'Select All', shortName: 'Select', code: 'G(KC_A)'},
        {name: 'Undo', code: 'G(KC_Z)', title: 'Command + Z'},
        {name: 'Redo', code: 'G(S(KC_Z))', title: 'Command + Shift + Z'},
        {name: 'Find', code: 'G(KC_F)', title: 'Command + F'},
        {name: 'New Tab', code: 'G(KC_T)', title: 'Command + T'},
        {
          name: 'Reopen Tab',
          code: 'G(S(KC_T))',
          title: 'Command + Shift + T',
        },
        {name: 'Previous Tab', shortName: 'Tab ←', code: 'C(S(KC_TAB))'},
        {name: 'Next Tab', shortName: 'Tab →', code: 'C(KC_TAB)'},
        {name: 'Desktop Left', shortName: 'Desk ←', code: 'C(KC_LEFT)'},
        {name: 'Desktop Right', shortName: 'Desk →', code: 'C(KC_RGHT)'},
        {
          name: 'Screenshot',
          shortName: 'Screen',
          code: 'G(S(KC_3))',
        ...
        },
        {
          ...
          shortName: 'Area',
          code: 'G(S(KC_4))',
          title: 'Command + Shift + 4',
        },
        {
          name: 'Screen Tools',
          shortName: 'Tools',
          code: 'G(S(KC_5))',
          title: 'Command + Shift + 5',
        },
        {
          name: 'Emoji',
          code: 'C(G(KC_SPC))',
          title: 'Control + Command + Space',
        },
      ],
    },
    {
      ...
      label: 'Macro',
      width: 'label',
      keycodes: generateMacros(numMacros, macroNames),
    },
    {
      id: 'gamepad',
      label: 'Gamepad',
      ...
      keycodes: [
        ...
        ['Right Paddle 2', 'RP2'],
        ['Left Stick Up', 'LS-UP'],
        ['Left Stick Down', 'LS-DN'],
        ['Left Stick Left', 'LS-L'],
        ['Left Stick Right', 'LS-R'],
        ['Right Stick Up', 'RS-UP'],
        ['Right Stick Down', 'RS-DN'],
        ['Right Stick Left', 'RS-L'],
        ['Right Stick Right', 'RS-R'],
      ].map(([name, shortName], index) => ({
        name,
        shortName,
        code: `JS_${index}`,
        title: `${name} digital gamepad button`,
      })),
    },
    buildLayerMenu(),
    {
...
export const getKeycodesForKeyboard = (
  ...
  if ('lighting' in definition) {
    ...
    includeList = categoriesForKeycodeModule('default').concat(
      keycodes.flatMap(categoriesForKeycodeModule),
    );
  }
  return getKeycodes(numMacros, macroNames)
    .flatMap((keycodeMenu) =>
